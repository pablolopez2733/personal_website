...
Enhanced plus-minus metrics in my undergrad thesis, predicting the 2015 NBA playoffs and evaluating the economic impact of player trades. [Link](https://github.com/pablolopez2733/NBA-Forecast/blob/main/reports/Tesis_PabloLopezLanderos.pdf)

#####   🏒Win Probability Models for WNHL

Applied Expected Threat (xT) metrics for hockey to assess game outcomes in the Women’s National Hockey League (WNHL) [Link](https://github.com/Echeney17/BigDataCup2021/blob/main/bdc_WP.pdf)
